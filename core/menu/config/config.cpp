...
bool c_config::load_config(std::string file_name) {
	CreateDirectory("C:\\aristois", NULL);
...
void c_config::create_config(std::string name) {
	CreateDirectory("C:\\aristois\\", NULL); CreateDirectory("C:\\aristois\\", NULL);
	std::ofstream ofs("C:\\aristois\\" + name + ".cfg");
}
